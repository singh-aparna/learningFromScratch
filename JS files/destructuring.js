...
//12//💡 Question: How can you destructure an array of objects?
const profiles = [
    { name: "Alice", role: "Developer" },
    { name: "Bob", role: "Designer" }
];
const [{ name: firstName }, { role: secondRole }] = profiles;
console.log(firstName, secondRole); // Output: Alice Designer
